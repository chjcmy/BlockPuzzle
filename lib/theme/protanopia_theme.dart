...
class ProtanopiaBlockPuzzleTheme implements AppTheme {
  @override
  ...
  final AppColor color = AppColor(
    ...
    primary: const Color(0xFF00796B), // 청록색
    onPrimary: const Color(0xFFFFFFFF),
    secondary: const Color(0xFFFFA000), // 노란색
    onSecondary: const Color(0xFF000000),
    tertiary: const Color(0xFF8E24AA), // 보라색
    ...
    diamondRank: const Color(0xFF00FFFF), // 밝은 청록색
